...
INSERT INTO `lich_truc` VALUES (3,'2026-04-09','ca4',5,'3','Nghĩa','registered',NULL,NULL,NULL,' (Chờ duyệt) | Đang chờ trực thay bởi: Vương (2) - Lý do: Không có lý do (Chờ duyệt) | Được trực thay bởi: Vương (2)','2026-04-09 08:25:56','2026-04-09 08:29:32'),(10,'2026-04-29','ca2',7,'4','Bảo','registered',NULL,NULL,NULL,' | - Lý do: Không có lý do (Chờ duyệt) | - Lý do: Không có lý do (Chờ duyệt) | Đang chờ trực thay bởi: Nghĩa (3) - Lý do: Không có lý do (Chờ duyệt) | Được trực thay bởi: Nghĩa (3)','2026-04-29 00:27:57','2026-04-29 00:31:32'),(11,'2026-04-29','ca4',7,'4','Bảo','registered',NULL,NULL,NULL,' | - Lý do: Không có lý do (Chờ duyệt)','2026-04-29 00:28:00','2026-04-29 00:29:07'),(13,'2026-04-29','ca3',5,'3','Nghĩa','registered',NULL,NULL,NULL,' | Đang chờ trực thay bởi: Vương (2) - Lý do: Không có lý do (Chờ duyệt) | Được trực thay bởi: Vương (2)','2026-04-29 00:28:42','2026-04-29 00:31:35'),(19,'2026-04-29','ca2',5,'3','Nghĩa','registered',NULL,NULL,NULL,'TRỰC THAY - Lịch gốc ID: 10 - Trực thay cho: Bảo (4) - Lý do: Không có lý do','2026-04-29 00:30:41','2026-04-29 00:30:41'),(20,'2026-04-29','ca4',5,'3','Nghĩa','registered',NULL,NULL,NULL,'TRỰC THAY - Lịch gốc ID: 17 - Trực thay cho: Vương (2) - Lý do: Không có lý do','2026-04-29 00:30:50','2026-04-29 00:30:50');
...
CREATE TABLE `nhanvien` (
  ...
  `face_login_enabled` tinyint(1) DEFAULT '1' COMMENT 'Cho phép đăng nhập bằng khuôn mặt',
  `face_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Mã xác thực bổ sung',
  `face_code_enabled` tinyint(1) DEFAULT '0' COMMENT 'Yêu cầu nhập mã khi login face',
  PRIMARY KEY (`id`),
...
INSERT INTO `nhanvien` VALUES (1,'admin','Quản trị viên hệ thống','$2b$10$J7A8fzh4uoyUTIPPRydllucZ2wRZBTBfMZlG33DnLJt10pZLP80Vu',1,'2026-04-05 09:04:53',NULL,1,NULL,0),(5,'3','Nghĩa','$2b$10$TpBHhgz750wOk/z7GaS4P.Zx/a4hspc6Jg3ehjTS7IRsBZv4qKpcC',0,'2026-04-09 08:00:33',NULL,1,'1234',1),(7,'4','Bảo','$2b$10$zEqdOUg4.H3uxuO4PtvwoOBWGagJ7XW8vQSDMLotVxPWdUbeyIICO',0,'2026-04-09 09:10:53',NULL,1,'123',1);
...
INSERT INTO `thong_bao_truc_thay` VALUES (4,7,5,10,'Nghĩa (3) đã yêu cầu trực thay ca ca2 ngày 29/4/2026 cho bạn. Đang chờ admin duyệt. Lý do: Không có lý do',0,NULL,'2026-04-29 00:28:35'),(5,7,5,10,'Nghĩa (3) đã yêu cầu trực thay ca ca2 ngày 29/4/2026 cho bạn. Đang chờ admin duyệt. Lý do: Không có lý do',0,NULL,'2026-04-29 00:28:48'),(6,7,5,11,'Nghĩa (3) đã yêu cầu trực thay ca ca4 ngày 29/4/2026 cho bạn. Đang chờ admin duyệt. Lý do: Không có lý do',0,NULL,'2026-04-29 00:28:54'),(8,7,5,10,'Nghĩa (3) đã yêu cầu trực thay ca ca2 ngày 29/4/2026 cho bạn. Đang chờ admin duyệt. Lý do: Không có lý do',0,NULL,'2026-04-29 00:30:41');
...
INSERT INTO `truc_thay` VALUES (7,10,7,5,19,'Không có lý do','active','2026-04-29 00:30:41','2026-04-29 00:31:32');
...
-- Dump completed on 2026-05-19 15:48:52
